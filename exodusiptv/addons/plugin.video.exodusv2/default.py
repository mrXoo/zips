...
#############Defined Strings#############
addon_id     = 'plugin.video.exodusv2'
...
host         = 'http://ifseenyourebanished.eu'
port         = '8080'
...
Guide = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.exodusv2/resources/catchup', 'guide.xml'))
GuideLoc = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.exodusv2/resources/catchup', 'g'))
...
def start():
	if username=="":
		...
		if auth == "":
			...
			line2 = "Welcome to [B]Exodus[/B]!" 
			line3 = ('[B][COLOR blue]%s[/COLOR][/B]'%user)
			xbmcgui.Dialog().ok('Exodus', line1, line2, line3)
			#addonsettings('ADS2','')
			xbmc.executebuiltin('Container.Refresh')
			#home()
			pvrsetup()
...
def searchdialog():
	search = control.inputDialog(heading='Search Exodus:')
	if search=="":
		return
	else:
		return search
...
def addonsettings(url,description):
	if   url =="CC":
		...
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.exodusv2/resources/modules/speedtest.py")')
	elif url =="META":
...
# def channelgroups(url,description):
		...
		# if dialog==0:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,)")
		# if dialog==1:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,USA | Sports)")		
		# elif dialog==2:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,UK | Sports HD)")
		# elif dialog==3:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,UK | Sports SD)")
		# elif dialog==4:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,US | Entertainment)")
		# elif dialog==5:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,UK | Entertainment HD)")
		# elif dialog==6:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,CANADA | Bell TV)")
		# elif dialog==7:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,US - Docs)")
		# elif dialog==8:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,UK - Docs)")
		# elif dialog==9:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,CA - Docs)")		
		# elif dialog==10:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,US - Kids)")
		# elif dialog==11:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,UK - Kids)")
		# elif dialog==12:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,CA - Kids)")
		# elif dialog==13:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,US - Movies)")
		# elif dialog==14:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,UK - Movies)")
		# elif dialog==15:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,CA - Movies)")
		# elif dialog==16:
			# xbmc.executebuiltin("RunScript(special://home/addons/plugin.video.exodusv2/resources/modules/opentvgroup.py,guide,)")
...
def correctPVR():
	...
	loginurl   = '%s:%s/get.php?username=%s&password=%s&type=m3u_plus&output=ts' %(host,port,username,password)
